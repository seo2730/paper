...
실내 탐색 임무 수행을 위한 응집도 기반 유전 알고리즘 이종 그룹 편제 및 임무 할당 기법. 
서덕현*,1) ․ 박재용1) ․ 윤태준1) ․ 김주영1) 
1)LIG넥스원
Put English Title Here 
Duckhyun Suh*,1) ․ Bohgoh Jang2)
1)LIG Nex1, Korea

(Received 00 February 2022 / Revised 00 February 2022 / Accepted 00 February 2022) [학회작성]

Abstract
  Swarm robotics is increasingly applied to indoor search, rescue, and defense tasks, yet mapless environments still present efficiency challenges. If every robot explores the same region, early coverage is rapid, but revisiting unsearched pockets and exchanging data later prolong overall mission time. A better strategy is to split robots into cohesive, size-appropriate sub-swarms matched to region scale. We propose a Cohesion-based heterogeneous Genetic Algorithm (CGA) that jointly optimizes robot-to-swarm formation and swarm-to-region allocation. CGA encodes candidate formations, evaluates them using inter-robot distance, remaining resources, and expected coverage, and evolves the population toward minimal completion time. Simulation on multistory indoor layouts shows CGA lowers average exploration time by 26 % and cuts communication overhead compared with allocation schemes that ignore swarm structure. The method offers a general framework for deploying large heterogeneous teams in unknown indoor spaces without prior maps, improving speed, robustness, and scalability in realistic disaster or security search scenarios.(수정 필요)

Key Words : Genetic Algorithm(유전 알고리즘), Coalition Formation(그룹 편제), Mission Task Allocation(임무 할당), Multi-Robot System(다중 로봇 시스템)
1. 서 론 (수정 필요)
...
2.2 임무 성능 요구사항 정의
2.3 임무 범위에 따른 개수 선정
  본 논문의 임무 성능 요구사항은 일정 탐사 영역에 대해 1개의 로봇이 수행할 수 있는 성능에 대한 요구사항이다.

                        (2)
는 임무 영역의 넓이다, 는 최대로 설정할 로봇의 개수 매개변수이고, 는 최소로 설정할 로봇의 개수 매개변수이다. 와 는 범위에 따라 사용자 원하는 개수를 설정하기 위한 그래프 기울기 설정 매개변수이다. 

2.3 시스템 모델
  
Fig. 1. 전체 시스템 계통도

3. 응집도 기반 유전 알고리즘 이종 그룹 편제 및 임무 할당 기법

3.1 알고리즘 순서


Fig. 2. 유전 알고리즘 플로우 차트
...
3.4 적합도 계산 및 세대 구성
 (1)
[HancomEQN, 9pt]
  내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오.
...
Fig. 3. Type here
[그림 제목, 영문으로 작성, 첫글자만 대문자, 마침표 없음, 돋움, 9pt, 장평 100%, 자간 -10%, 줄간격 150%, 한줄일 경우 중앙 정렬, 2줄 이상일 경우 양쪽 정렬]
  
내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오 내용을 입력하시오. 내용을 입력하시오.

Table 1. Type here
[표 제목, 영문으로 작성, 첫글자만 대문자, 마침표 없음, 돋움, 9pt, 장평 100%, 자간 -10%, 줄간격 150%, 한줄일 경우 중앙 정렬, 2줄 이상일 경우 양쪽 정렬]
...
[표안 본문 서체와 동일]
  ...
  내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오.

5. 결 론

  내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오. 내용을 입력하시오.
사사
[돋움 진하게, 9.5pt, 장평 100%, 자간 -5%, 가운데 정렬]
...
[5] D. Silveria, K. Cabral and S. Givigi, "Scalable Swarm Control Using Deep Reinforcement Learning," 2025 IEEE International systems Conference (SysCon), Montreal, QC, Canada, 2025, pp. 1-8, doi: 10.1109/SysCon64521.2025.11014655.
